                                    ...
                                    <form id="application_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control application_from_date" name="application_from_date" placeholder="YYYY-MM-DD" required>
                                            </div>

                                            <div class="col-md-5">
                                                <label for="inputPassword3" class="col-form-label">To Date <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control application_to_date" name="application_to_date" placeholder="YYYY-MM-DD" required> 
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="d-none" id="total_days_section">
                                                    ...
                                                    <input type="text" class="form-control" name="total_days_count" id="total_days_count" value="" readonly>
                                                </div>
                                        ...
                                        <div class="application_section d-none">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" name="employee" id="employee" data-live-search="true" data-size="5" required data-parsley-errors-container=".employeeError" title="-- Select Employee --">
                                                        @foreach($allEmployee as $value)
                                                            <option value="{{$value->id}}">{{$value->name}} ({{$value->emp_code}})</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="project" id="project" placeholder="Enter Project Name" autocomplete="off"> 
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="inputPassword3" class="col-form-label">Contact <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="contact" id="contact" placeholder="Enter Contact" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minLength="10" maxLength="10" autocomplete="off" required> 
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" rows="2" name="address" id="address" placeholder="Write Address" required></textarea>
                                                </div>
                                            </div>                                           
                                            ...
                                            <div class="application_date_section">
                                                <div class="section" id="1">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <label for="inputPassword3" class="col-form-label">From Date <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control from_date" name="from_date[]" placeholder="YYYY-MM-DD" value=""  autocomplete="off" required>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label for="inputPassword3" class="col-form-label">To Date <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control to_date" name="to_date[]" placeholder="YYYY-MM-DD" value=""  autocomplete="off" required> 
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <select class="form-control shift_type" name="shift_type[]" required data-parsley-errors-container=".shiftError" title="-- Select Shift Type --">
                                                                @foreach($allShiftType as $key => $type)
                                                                    <option value="{{$type}}" @if($type === "full_day") {{"selected"}} @endif>{{$key}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-md-1">
                                                            ...
                                                            <div class="days_label text-center"></div>
                                                            <input type="hidden" class="form-control days" name="days[]" placeholder="Days" readonly>
                                                        </div>
                                                    </div>  
                                                </div>
                                            </div>                              
            ...
            $(document).ready(function() {
                ...
                $("#apply_detail").click(function(event){
                    ...
                    if(application_from_date !='' && application_to_date !=''){
                        ...
                        $(".from_date").val(application_from_date);
                        $(".to_date").val(application_to_date);
                        ...
                        $("#total_days_count, .days").val(result);
                ...
                $('body').delegate('#application_form', 'submit', function(e) { 
                    ...
                    if($('#application_form').parsley().isValid()) {  
                        ...
                        $.ajax({
                            url:"{{ url('application/insert-application') }}",  
                            type:"post", 
                            dataType:"json",
