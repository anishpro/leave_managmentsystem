                ...
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-md-12 mb-4 mt-2 text-right">
                            <a href="{{url('travel_request/add')}}" class="btn btn-default btn-icon mr-1" tooltip="Add New"><i class="bx bx-plus f-s-14 align-middle m-b-2"></i></a> 
                                            ...
                                            <tr>
                                                <th width="5%">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="request_selectall" id="request_selectall">
                                                        <label class="form-check-label" for="request_selectall"></label>
                                                    </div>
                                                </th>
                                                <th>Employee</th>
                                                <th>PO</th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {  
                ...
                function viewTravelDetail() {
                    $.ajax({
                        type:'get', 
                        url:'travel_request/fetch_travelrequest',
