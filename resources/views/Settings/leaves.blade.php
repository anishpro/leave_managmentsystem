                ...
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-md-12 mb-4 mt-2 text-right">
                            <a href="javascript:void(0);" class="btn btn-default btn-icon mr-1" tooltip="Add New" id="add_leavetype"><i class="bx bx-plus f-s-14 align-middle m-b-2"></i></a> 

                            <button type="submit" class="btn btn-default btn-icon" id="leavetype_delete" tooltip="Delete"><i class="bx bx-trash f-s-14 align-middle m-b-2"></i></button> 
                        </div>
                                            ...
                                            <tr>
                                                <th width="5%">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="leavetype_selectall" id="leavetype_selectall">
                                                        <label class="form-check-label" for="leavetype_selectall"></label>
                                                    </div>
                                                </th>
                                                <th>LeaveType</th>
                                                <th>Added Date</th>
...
@section('scriptcontent')        
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                // Select all checkbox
                $("body").delegate("#leavetype_selectall", "change", function () {
                    $(".leavetype_checkbox:checkbox").prop('checked', $(this).prop("checked")); 
                });

                // Multiple checkbox delete leavetype
                $('#leavetype_delete').click(function() { 

                    var id = [];

                    $('.leavetype_checkbox:checked').each(function(i) {
                        id[i] = $(this).val();
                    });
