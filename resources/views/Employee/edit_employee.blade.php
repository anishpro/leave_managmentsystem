                                    ...
                                    <form id="employee_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="employee" id="employee" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" placeholder="Enter Employee Name" value="{{$employee->name}}" autocomplete="off" required>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="employee_code" id="employee_code" placeholder="Enter Employee Code" value="{{$employee->emp_code}}" autocomplete="off" required>
                                            </div>

                                            <div class="col-md-4"> 
                                                <label for="inputEmail3" class="col-form-label">Username <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="username" id="username" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" value="{{$username}}" placeholder="Enter Username" autocomplete="off" required>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="position" id="position" required data-parsley-errors-container=".positionError" title="-- Select Position --" data-live-search="true" data-size="5">';
                                                    @foreach($allPositions as $value)
                                                        <option value="{{$value->id}}" @if($employee->position == $value->id) {{"selected"}} @endif>{{$value->position}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="role_id" id="role_id" required data-parsley-errors-container=".roleError" title="-- Select Role --" data-live-search="true" data-size="5">';
                                                    @foreach($allRoles as $value)
                                                        <option value="{{$value->id}}" @if($employee->role_id == $value->id) {{"selected"}} @endif>{{ucwords($value->role)}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="duty_station" id="duty_station" required data-parsley-errors-container=".dutyError" title="-- Select Position --" data-live-search="true" data-size="5">';
                                                    @foreach($allStations as $value)
                                                        <option value="{{$value->id}}" @if($employee->duty_station == $value->id) {{"selected"}} @endif>{{$value->work_place}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">   
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="group_id" id="group_id" required data-parsley-errors-container=".productError" title="-- Select Group --" data-live-search="true" data-size="5">';
                                                    @foreach($allGroups as $value)
                                                        <option value="{{$value->id}}" @if($employee->group_id == $value->id) {{"selected"}} @endif>{{ucfirst($value->group_name)}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="contact" id="contact" value="{{$employee->phone}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minLength="10" maxLength="10" placeholder="Enter Contact Number" autocomplete="off" required>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="inputEmail3" class="col-form-label">Email <span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" name="email" id="email" value="{{$employee->email}}" placeholder="Enter Email" autocomplete="off" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="address" id="address" placeholder="Address" autocomplete="off" rows="2">{{$employee->address}}</textarea>
                                            </div>
                                        </div> 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="get_signature_preview mt-3">
                                                    @if($employee->signature != 'NULL')
                                                        <img src="{{url('uploads/signature')}}/{{$employee->signature}}" class="rounded" style="height:80px;">
                                                        <input type="hidden" name="old_signature" value="{{$employee->signature}}">
                                                    @else
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="get_image_preview mt-3"> 
                                                    @if($employee->profile != 'NULL')
                                                        <img src="{{url('uploads/profile')}}/{{$employee->profile}}" class="rounded" style="height:80px;">
            ...
            $(document).ready(function() {
                ...
                $('body').delegate('#employee_form', 'submit', function(e) { 
                    ...
                    if($('#employee_form').parsley().isValid()) {  
                        ...
                        $.ajax({
                            url:"{{ url('employees/update-employee') }}",  
                            type:"post", 
                            dataType:"json",
                            ...
                            success:function(result) { 
                                ...
                                if(result == 'exist') { 
                                    ...
                                    $(".result").html(' <div class="alert alert-warning alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>Email and Emp Code exists</div>');
