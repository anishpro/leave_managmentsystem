<template>
    <div class="container">
                ...
                <div class="card rounded-0">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover m-0">
                            ...
                            <tr v-for="(contract_type, index) in records.data" :key="contract_type.id">
                                <td>{{index + 1}}</td>
                                <td>{{contract_type.name}}</td>
                                <td>
                                    <a href="#" @click="editModal(contract_type)" class=" text-success mr-2">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="#" @click="deleteContent(contract_type.id)" class=" text-danger mr-2">
        ...
        <!-- contact Modal -->
         <modal :form="form" :modal_data="modal_data" :editmode="editmode" :api_url="'contract-type'">
                    <div class="form-group col-md-12">
                        <label for="" class=" col-form-label">Name <span class="text-danger">*</span></label>
                        <div class="">
                            <input type="text" class="form-control" v-model="form.name" id="" placeholder="Enter Contract Type Name" autocomplete="off" required>
                        </div>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                component_name : 'Contract Type',
                editmode: false,
                disabled: false,
                records:{},
                modal_data:{
                    modal_size:'',
                    modal_name:'addNewContractType'
                },
                form: new Form({
                    id: null,
                    name: null,
